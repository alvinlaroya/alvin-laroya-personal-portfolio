import { defineComponent, inject, provide, computed, shallowRef, h, resolveComponent, useSlots, ref, mergeProps, unref, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString, createVNode, toRef, toValue, watch, resolveDynamicComponent, getCurrentInstance, onServerPrefetch, hasInjectionContext, isRef, mergeModels, useModel, createTextVNode, useAttrs, nextTick, createElementBlock, cloneVNode, defineAsyncComponent, useSSRContext, shallowReactive, Suspense, Fragment, createApp, renderList, useId, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, withModifiers, getCurrentScope, markRaw } from 'vue';
import { q as serialize, t as parseQuery, v as klona, w as defuFn, x as defu, y as hasProtocol, z as joinURL, A as isEqual, B as withQuery, C as withTrailingSlash, D as withoutTrailingSlash, E as isScriptProtocol, F as getContext, c as createError$1, G as sanitizeStatusCode, H as withLeadingSlash, I as parseURL, $ as $fetch$1, J as baseURL, K as createHooks, L as executeAsync, s as setCookie, f as getHeader, M as encodeParam, N as encodePath, O as toRouteMatcher, P as createRouter$1 } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CIO62v7t.mjs')
  },
  {
    name: "reviews",
    path: "/reviews",
    component: () => import('./index-DADyDY1l.mjs')
  }
];
...
const ipxRuntime$tK8PivzFZrGf1Tq3HopXpWuEYxPxSD_tq0zpLa9Pl1E = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  operationsGenerator,
  supportsAlias,
...
const imageOptions = {
  ...
  providers: {
    ["ipx"]: { provider: ipxRuntime$tK8PivzFZrGf1Tq3HopXpWuEYxPxSD_tq0zpLa9Pl1E, defaults: {} }
  }
};
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-B5sozUro.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-fY5fmLLl.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DxoPu_Rx.mjs'));
...
export { formBusInjectionKey as A, formInputsInjectionKey as B, formLoadingInjectionKey as C, formOptionsInjectionKey as D, inputIdInjectionKey as E, formFieldInjectionKey as F, useFormField as G, looseToNumber as H, _export_sfc as _, __nuxt_component_0$2 as a, useAppConfig as b, usePortal as c, __nuxt_component_1$1 as d, entry$1 as default, _sfc_main$8 as e, useLocale as f, useButtonGroup as g, useComponentIcons as h, _sfc_main$e as i, _sfc_main$b as j, __nuxt_component_0$1 as k, useSeoMeta as l, _sfc_main$9 as m, _sfc_main$a as n, get as o, pickLinkProps as p, useNuxtApp as q, useToast as r, fetchDefaults as s, tv as t, useHead as u, useAsyncData as v, useRequestFetch as w, useRoute as x, useRuntimeConfig as y, avatarGroupInjectionKey as z };
