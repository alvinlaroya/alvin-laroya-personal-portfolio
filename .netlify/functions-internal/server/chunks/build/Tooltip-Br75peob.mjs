import { useSlots, computed, provide, unref, mergeProps, withCtx, createVNode, resolveDynamicComponent, createBlock, createCommentVNode, openBlock, Fragment, renderList, toRef, renderSlot, toDisplayString, createTextVNode, reactive, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderList, ssrRenderVNode, ssrRenderSlot, ssrRenderClass, ssrInterpolate } from 'vue/server-renderer';
import { Primitive, useForwardPropsEmits, TooltipRoot, TooltipTrigger, TooltipPortal, TooltipContent, TooltipArrow } from 'reka-ui';
import { b as useAppConfig, t as tv, z as avatarGroupInjectionKey, j as _sfc_main$b, c as usePortal } from './server.mjs';
      ...
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              hiddenCount.value > 0 ? (openBlock(), createBlock(_sfc_main$b, {
                key: 0,
                text: `+${hiddenCount.value}`,
                class: ui.value.base({ class: props.ui?.base })
...
//# sourceMappingURL=Tooltip-Br75peob.mjs.map
