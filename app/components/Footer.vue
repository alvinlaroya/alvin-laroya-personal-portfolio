<template>
    <div class="border-t border-gray-600 mt-7">
        <footer class="text-white py-12 max-w-screen-lg mx-auto">
                    ...
                    <div>
                        ...
                        <div id="formMessage" class="mt-4 hidden">
                            <div id="successMessage"
                                class="bg-green-800 border border-green-600 text-green-100 px-4 py-3 rounded-lg hidden">
                                <p class="font-medium">Message sent successfully!</p>
                                <p class="text-sm">Thank you for reaching out. I'll get back to you soon.</p>
                            </div>
                            <div id="errorMessage"
                                class="bg-red-800 border border-red-600 text-red-100 px-4 py-3 rounded-lg hidden">
                                <p class="font-medium">Oops! Something went wrong.</p>
                                <p class="text-sm">Please try again or contact me directly via email.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="flex space-x-4">
                                    ...
                                    <a href="#"
                                        class="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gray-700 transition-colors duration-200">
                                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd"
                                    ...
                                    <a href="#"
                                        class="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-500 transition-colors duration-200">
                                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                            <path
